...
#   Customizations
#================================================
[string]$ModuleVersion = Get-Module -Name OSDBeta | Sort-Object -Property Version | Select-Object -ExpandProperty Version -Last 1
$formMainWindow.Title = "OSDScripts Beta $ModuleVersion"
#================================================
#   Hide Windows
#================================================
#Hide-CmdWindow
